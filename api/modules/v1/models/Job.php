...
class Job extends \yii\db\ActiveRecord
{
    ...
    /**
     * Function to handle job x company association
     *
     * @param bool $insert
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        if ($insert) {
            ...
            // Create an object to associate job x company
            $jobCompany = new CompanyHasJob();

            // Associate the user with company
            $jobCompany->company_id = $companyID['company_id'];
            $jobCompany->job_id = $jobID;
            $jobCompany->save();
        }
